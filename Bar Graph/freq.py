...
class SpotifyAPI(object):
    ...
    auth_url = "https://accounts.spotify.com/en/authorize?client_id=xxxxxxxxxxxxxxxxxxxxxxxxx&scope=user-read-recently-played&response_type=code&show_dialog=true&redirect_uri=https%3A%2F%2Fdeveloper.spotify.com%2Fdocumentation%2Fweb-api%2Freference%2Fplayer%2Fget-recently-played%2F"
    webbrowser.open_new_tab(auth_url)
    token_url = "https://accounts.spotify.com/api/token"
    hist_url = "https://api.spotify.com/v1/me/player/recently-played?limit=10"
...
# function to get parse out the info I want, and enter in dict. Later used to map both on x-axis, and value (freq) on y-axis
    def artist_track_name(self):
        # adding the names into a dict
        frequency = {}
        for i in range(len(spotify.history['items'])):
            ...
            both = artist_name + ' - ' + track_name
            if both in frequency:
                frequency[both] += 1
            else:
                frequency[both] = 1
        print(frequency)
